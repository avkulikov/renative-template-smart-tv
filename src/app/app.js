...
const Tile = ({ children, title }) => (
   <View style={{ margin: 5, maxWidth: 200, minWidth: 150, borderWidth: 1, borderColor: '#CCCCCC' }}>
      <Text>{title}</Text>
      <View style={{ borderTopWidth: 1, borderTopColor: '#CCCCCC', minHeight: 50, padding: 5 }}>{children}</View>
   </View>
);
...
const App = () => (
   <ScrollView contentContainerStyle={{ paddingTop: 50 }}>
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' }}>
         ...
         <Tile title='Image'>
            <Image style={{ width: 50, height: 50 }} source={{ uri: 'https://renative.org/img/logo.png' }} />
         </Tile>
         <Tile title='Button'>
            <Button title='OK' />
         </Tile>
         ...
         <Tile title='ImageBackground'>
            <ImageBackground
               source={{ uri: 'http://gis.mrrb.government.bg/tiles/mrr_vids/16/36914/23809.png' }}
               style={{ flex: 1 }}>
               <Text>Lorem Ipsum</Text>
            </ImageBackground>
         </Tile>
